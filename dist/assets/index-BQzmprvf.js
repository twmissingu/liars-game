...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/(function(e){function t(N,E){var z=N.length;N.push(E);e:for(;0<z;){var Y=z-1>>>1,ee=N[Y];if(0<a(ee,E))N[Y]=E,N[z]=ee,z=Y;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var E=N[0],z=N.pop();if(z!==E){N[0]=z;e:for(var Y=0,ee=N.length,lr=ee>>>1;Y<lr;){var kt=2*(Y+1)-1,Aa=N[kt],wt=kt+1,ir=N[wt];if(0>a(Aa,z))wt<ee&&0>a(ir,Aa)?(N[Y]=ir,N[wt]=z,Y=wt):(N[Y]=Aa,N[kt]=z,Y=kt);else if(wt<ee&&0>a(ir,z))N[Y]=ir,N[wt]=z,Y=wt;else break e}}return E}function a(N,E){var z=N.sortIndex-E.sortIndex;return z!==0?z:N.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,f=s.now();e.unstable_now=function(){return s.now()-f}}var p=[],g=[],x=1,l=null,i=3,c=!1,m=!1,y=!1,v=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(N){for(var E=n(g);E!==null;){if(E.callback===null)r(g);else if(E.startTime<=N)r(g),E.sortIndex=E.expirationTime,t(p,E);else break;E=n(g)}}function _(N){if(y=!1,b(N),!m)if(n(p)!==null)m=!0,Na(w);else{var E=n(g);E!==null&&Ta(_,E.startTime-N)}}function w(N,E){m=!1,y&&(y=!1,d(T),T=-1),c=!0;var z=i;try{for(b(E),l=n(p);l!==null&&(!(l.expirationTime>E)||N&&!le());){var Y=l.callback;if(typeof Y=="function"){l.callback=null,i=l.priorityLevel;var ee=Y(l.expirationTime<=E);E=e.unstable_now(),typeof ee=="function"?l.callback=ee:l===n(p)&&r(p),b(E)}else r(p);l=n(p)}if(l!==null)var lr=!0;else{var kt=n(g);kt!==null&&Ta(_,kt.startTime-E),lr=!1}return lr}finally{l=null,i=z,c=!1}}var S=!1,C=null,T=-1,A=5,L=-1;function le(){return!(e.unstable_now()-L<A)}function R(){if(C!==null){var N=e.unstable_now();L=N;var E=!0;try{E=C(!0,N)}finally{E?I():(S=!1,C=null)}}else S=!1}var I;if(typeof h=="function")I=function(){h(R)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,He=$.port2;$.port1.onmessage=R,I=function(){He.postMessage(null)}}else I=function(){v(R,0)};function Na(N){C=N,S||(S=!0,I())}function Ta(N,E){T=v(function(){N(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){m||c||(m=!0,Na(w))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return i},e.unstable_getFirstCallbackNode=function(){return n(p)},e.unstable_next=function(N){switch(i){case 1:case 2:case 3:var E=3;break;default:E=i}var z=i;i=E;try{return N()}finally{i=z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,E){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var z=i;i=N;try{return E()}finally{i=z}},e.unstable_scheduleCallback=function(N,E,z){var Y=e.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?Y+z:Y):z=Y,N){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=z+ee,N={id:x++,callback:E,priorityLevel:N,startTime:z,expirationTime:ee,sortIndex:-1},z>Y?(N.sortIndex=z,t(g,N),n(p)===null&&N===n(g)&&(y?(d(T),T=-1):y=!0,Ta(_,z-Y))):(N.sortIndex=ee,t(p,N),m||c||(m=!0,Na(w))),N},e.unstable_shouldYield=le,e.unstable_wrapCallback=function(N){var E=i;return function(){var z=i;i=E;try{return N.apply(this,arguments)}finally{i=z}}}})(bs);ys.exports=bs;var Wc=ys.exports;/**
* @license React
...
//# sourceMappingURL=index-BQzmprvf.js.map
